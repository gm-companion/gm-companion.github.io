...
See the instructions [here](/documentation/audio.html#spotify).
...
Here you can enable / disable addons. For more information see [_addons_](/documentation/addons.html).
